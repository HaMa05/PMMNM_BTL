            ...
            <div class="col-xs-6" :class="{
                ...
                <article>
                    ...
                    <div class="figure-grid">
                        ...
                        <div class="text" style="background: rgba(255, 255, 255, 0.8);">
                            <h2 class="title h4"><NuxtLink :to="`/san-pham/${product.slug}`"> {{ product.name }}</NuxtLink></h2>
                            <sup style="color: #FF4848; font-weight: bold; font-size: 20px">{{ Intl.NumberFormat('vi-VN', { style: 'currency', currency: 'VND' }).format( product.unit_price * (100 - product.sale) / 100 ) }}</sup>
                            <sub v-if="product.sale > 0" style="color: #FF4848; font-size: 20px">{{ Intl.NumberFormat('vi-VN', { style: 'currency', currency: 'VND' }).format( product.unit_price ) }}</sub>
