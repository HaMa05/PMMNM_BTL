    ...
    <section class="checkout">
      <b-container>
        ...
        <div class="cart-wrapper">
          ...
          <div class="clearfix">
            <div
              class="cart-block cart-block-item clearfix py-2 pl-2"
            ...
            >
              ...
              <div class="quantity">
                <input
                  ...
                  type="number"
                  :value="item.quantity"
                  @input="handleChangeAmount($event, index)"
              ...
              <div class="price">
                <span class="final h3">{{
                  Intl.NumberFormat("vi-VN", {
                    style: "currency",
                    currency: "VND"
                  }).format((item.price * (100 - item.sale)) / 100)
                }}</span>
                <span class="discount" v-if="item.sale > 0">{{
                  Intl.NumberFormat("vi-VN", {
                    style: "currency",
                    currency: "VND"
                  }).format(item.price)
              ...
              <!--delete-this-item-->
              <span
                class="icon icon-cross icon-delete"
          ...
          <div class="clearfix">
            <div
              class="cart-block cart-block-footer cart-block-footer-price clearfix"
            >
              <div>
          ...
          <div class="clearfix pt-3">
            <div class="row">
              <div class="col-xs-6">
                <a href="#" class="btn btn-clean-dark"
                  ><span class="icon icon-chevron-left"></span> Mua thêm</a
                >
              </div>
              <div class="col-xs-6 text-right" v-if="active == 1">
                <a href="#" class="btn btn-main" @click.prevent="next"
                  ><span class="icon icon-cart"></span> Tiếp tục</a
                >
              </div>
              <div class="col-xs-6 text-right" v-if="active == 2">
                <a href="#" class="btn btn-main" @click.prevent="checkout"
                  ><span class="icon icon-cart"></span> Thanh toán</a
                >
              </div>
            </div>
          </div>
  ...
  computed: {
    ...
    totalPriceCart() {
      const total = this.listCart.reduce((total, item) => {
        const price = (item.price * (100 - item.sale)) / 100;
