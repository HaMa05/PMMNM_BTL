    ...
    methods: {
      dataRevenueOfWeek(data) {
        data.forEach(element => {
          ...
          switch (date.getDay()) {
            case 0:
              this.revenueOfWeek[6] = parseInt(element.sale)
              break;
            case 1:
              this.revenueOfWeek[0] = parseInt(element.sale)
              break;
            case 2:
              this.revenueOfWeek[1] = parseInt(element.sale)
              break;
            case 3:
              this.revenueOfWeek[2] = parseInt(element.sale)
              break;
            case 4:
              this.revenueOfWeek[3] = parseInt(element.sale)
              break;
            case 5:
              this.revenueOfWeek[4] = parseInt(element.sale)
              break;
            case 6:
              this.revenueOfWeek[5] = parseInt(element.sale)
              break;
            default:
              break;
          }
      ...
      dataRevenueOfMonth(data) {
        data.forEach(element => {
          this.revenueOfMonth[element.month - 1] = parseInt(element.sale)
        })
      }
    },
    async created() {
